...
from .constants import (
                        API_CATEGORIES, API_PAGE_SIZE,
                        API_PAGES_NUMBER, API_URL_SOURCE)
import requests as rq


class Database():
    """
    Inserts into the database the categories and
    all the product keys it requires
        ...
        for category in API_CATEGORIES:
            ...
            for page in range(pages):
                payload = {
                    ...
                    'page_size': API_PAGE_SIZE, 'page': page,  'json': 1}
                        ...
                        try:
                            Product.objects.create(
                                ...
                                lipids_for_100g=product["nutriments"].get(
                                    "fat_100g"),
                                saturated_fats_for_100g=product[
